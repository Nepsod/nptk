...
use settings_content::PlatformOverrides;

/// Applies a migration callback to the root settings object as well as all
/// nested platform and profile override objects.
pub(crate) fn migrate_settings(
    ...
    let override_keys = PlatformOverrides::OVERRIDE_KEYS.iter().copied();
...
/// at the root level as well as all nested platform and profile override objects.
