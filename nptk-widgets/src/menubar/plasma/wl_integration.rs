...
/// Set the application menu for a Wayland surface using VGI's public appmenu API.
///
/// This function uses VGI's public appmenu API to set the appmenu on a surface.
...
pub fn set_appmenu_for_surface_via_wl_client(
    ...
    // Use VGI's public appmenu API
    nptk_core::vgi::appmenu::set_appmenu_for_surface(surface, service, path)
}
...
pub fn notify_wl_client_menu_update() {
    ...
    // Use VGI's public appmenu API
    nptk_core::vgi::appmenu::update_appmenu_for_all_surfaces(service, path);
}
